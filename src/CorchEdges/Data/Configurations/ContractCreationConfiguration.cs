...
public class ContractCreationConfiguration : BaseEntityConfiguration<ContractCreation>
{
    ...
    public override IEnumerable<ColumnMetaInfo> GetColumnMetadata()
    {
        ...
        [
            ...
            new ColumnMetaInfo(nameof(ContractCreation.KeyMoney), "礼金(家)", "numeric(12,0)"),
            new ColumnMetaInfo(nameof(ContractCreation.SecurityDeposit), "敷金(家)", "numeric(12,0)"),
            ...
            new ColumnMetaInfo(nameof(ContractCreation.ApartmentInsurance), "ｱﾊﾟ-ﾄ保険代", "numeric(12,0)"),
